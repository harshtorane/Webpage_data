            ...
            <div class="tp-banner" >
                <ul>    <!-- SLIDE  -->
                    ...
                    <li data-transition="random" data-slotamount="6" data-masterspeed="1000" >
                        <!-- MAIN IMAGE -->
                        <img src="assets/images/home1-slideshow1.jpg"  alt="Futurelife-home2-slideshow"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                    ...
                    <li data-transition="random" data-slotamount="6" data-masterspeed="1000" >
                        <!-- MAIN IMAGE -->
                        <img src="assets/images/home1-slideshow2.jpg"  alt="Futurelife-home2-slideshow"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
            ...
            <div class="container">
                ...
                <div class="featured-products home_2 new-arrivals lastest">
                    <ul class="tabs tabs-title">
                        <li class="item" rel="tab_1">All Product</li>
                        ...
                        <div id="tab_1" class="tab-content">
                            <div class="products hover-shadow ver2 border-space-product">
                                ...
                                <div class="product">
                                    ...
                                    <a href="#" title="Union Bed"><p class="product-title">Mango</p></a>
                                    <p class="product-price-old">$700.00</p>
                                    <p class="product-price">$350.00</p>
                                </div>
                                <!-- End item -->
                                <div class="product">
                                    ...
                                    <a href="#" title="Union Bed"><p class="product-title">BlackBerry</p></a>
                                    <p class="product-price-old">$700.00</p>
                                    <p class="product-price">$350.00</p>
                                ...
                                <div class="product">
                                    ...
                                    <a href="#" title="Union Bed"><p class="product-title">Peach</p></a>
                                    <p class="product-price-old">$700.00</p>
                                    <p class="product-price">$350.00</p>
                                ...
                                <div class="product">
                                    ...
                                    <a href="#" title="Union Bed"><p class="product-title">RedBerry</p></a>
                                    <p class="product-price-old">$700.00</p>
                                    <p class="product-price">$350.00</p>
                                ...
                                <div class="product">
                                    ...
                                    <a href="#" title="Union Bed"><p class="product-title">Spices</p></a>
                                    <p class="product-price-old">$700.00</p>
                                    <p class="product-price">$350.00</p>
                                ...
                                <div class="product">
                                    ...
                                    <a href="#" title="Union Bed"><p class="product-title">Cucumber</p></a>
                                    <p class="product-price-old">$700.00</p>
                                    <p class="product-price">$350.00</p>
                                ...
                                <div class="product">
                                    ...
                                    <a href="#" title="Union Bed"><p class="product-title">Tomato</p></a>
                                    <p class="product-price-old">$700.00</p>
                                    <p class="product-price">$350.00</p>
                                </div>
                                <!-- End item -->
                                <div class="product">
                                    ...
                                    <a href="#" title="Union Bed"><p class="product-title">Male</p></a>
                                    <p class="product-price-old">$700.00</p>
                                    <p class="product-price">$350.00</p>
                                ...
                                <div class="product">
                                    ...
                                    <a href="#" title="Union Bed"><p class="product-title">Passion Fruit</p></a>
                                    <p class="product-price-old">$700.00</p>
                                    <p class="product-price">$350.00</p>
